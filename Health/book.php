...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="book.php" method="post">
            ...
            <select class="box" name="Specialization" >
            ...
            <select class="box" name="doctor">
              ...
              <input type="date" class="box" name="data">
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>our services</h3>
            <a href="book.php"> <i class="fas fa-chevron-right"></i> book an appointment </a>
            <a href="search.php"> <i class="fas fa-chevron-right"></i> Search an Doctors</a>
        </div>

        <div class="box">
            <h3>contact info</h3>
            <a href="#"> <i class="fas fa-phone"></i> +201224563274 </a>
            <a href="#"> <i class="fas fa-phone"></i> +201224563274</a>
            <a href="#"> <i class="fas fa-envelope"></i> mohagamal475@gmail.com</a>
